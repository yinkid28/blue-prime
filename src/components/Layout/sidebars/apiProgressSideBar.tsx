              ...
              <DrawerBody className="space-y-4 mt-20 bg-light-grey p-2">
                ...
                <div className="bg-white h-[72%] rounded p-5 flex flex-col gap-4">
                  ...
                  <div
                    className={`flex items-center cursor-pointer ease-in-out duration-700 hover:text-primary gap-3 w-full ${
                      router.asPath ==
                      `/weaver/api_details/${api.name}/overview`
                        ? "text-primary"
                        : "text-dark-grey"
                    }`}
                    onClick={() => {
                  ...
                  <div
                    className={`flex items-center cursor-pointer ease-in-out duration-700 hover:text-primary gap-3 w-full ${
                      router.asPath ==
                      `/weaver/api_details/${api.name}/endpoints`
                        ? "text-primary"
                        : "text-dark-grey"
                    }`}
                    onClick={() => {
                  ...
                  <div
                    className={`flex items-center cursor-pointer ease-in-out duration-700 hover:text-primary gap-3 w-full ${
                      router.asPath == `/weaver/api_details/${api.name}/modules`
                        ? "text-primary"
                        : "text-dark-grey"
                    }`}
                    onClick={() => {
                  ...
                  <div
                    className={`flex items-center cursor-pointer ease-in-out duration-700 hover:text-primary gap-3 w-full ${
                      router.asPath ==
                      `/weaver/api_details/${api.name}/api_definition`
                        ? "text-primary"
                        : "text-dark-grey"
                    }`}
                    onClick={() => {
