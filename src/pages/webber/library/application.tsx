...
export default function Application() {
  ...
  const getAllApplications = async (pageNumber: number, pageSize: number) => {
    setIsLoadingApps(true);
    try {
      const res = await APIServices.getAllWebberApplications(pageNumber, pageSize);
        ...
        {editingApp && (
          <EditApp
            ...
            onClose={() => {
              onEditClose();
              setEditingApp(null);
              getAllApplications(pageNumber, searchTerm);
            }}
            onSuccess={() => getAllApplications(pageNumber, searchTerm)}
            appco={editingApp}
          />
        )}
      </>
...
//     async (pageNumber = 0, pageSize = 12) => {
//       setIsLoadingApps(true);
//       try {
//         const res = await APIServices.getAllWebberApplications(pageNumber, pageSize);
//         if (res.statusCode === 200) {
